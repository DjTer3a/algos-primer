...
assert.strictEqual(deque.addToHead(1), 1, "Size should be 1 after adding to head");
assert.strictEqual(deque.addToHead(2), 2, "Size should be 2 after adding to head again");

// Test addToTail
assert.strictEqual(deque.addToTail(3), 3, "Size should be 3 after adding to tail");
...
deque.addToTail(4);
assert.strictEqual(deque.goToNext(deque.head).value, 4, "Next node should have value 4");
assert.strictEqual(deque.goToPrev(deque.tail).value, 1, "Previous node should have value 1");
...
assert.strictEqual(emptyDeque.removeFromHead(), null, "Removing from empty deque should return null");
assert.strictEqual(emptyDeque.removeFromTail(), null, "Removing from empty deque should return null");


assert.strictEqual(emptyDeque.addToHead(1), 1, "Size should be 1 after adding to head");
assert.strictEqual(emptyDeque.addToHead(2), 2, "Size should be 2 after adding to head again");
